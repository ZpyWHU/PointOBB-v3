...
model = dict(
    ...
    scale_classes = [11, 18],
    scale_classes2 = [2, 3, 6, 7, 9, 14, 20, 25, 28, 32],
    ...
    roi_head=dict(
        ...
        agnostic_resize_classes = [20, 21, 24, 25, 33],
...
# dataset_type = 'FAIR1MDataset' # for test
angle_version = 'le90'
...
data_root = '/datasets/mmrotate_data/split_ss_fair1m_1_0/' 
...
data = dict(
    ...
    train=dict(
        ...
        ann_file = data_root + "train/trainval_1024_P2Bfmt_dota_rbox.json",
