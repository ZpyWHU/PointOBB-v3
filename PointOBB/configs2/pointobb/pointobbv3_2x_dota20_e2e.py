...
model = dict(
    ...
    scale_classes = [6, 8, 9, 11, 12, 13, 17],
    scale_classes2 = [0],
    ...
    roi_head=dict(
        ...
        agnostic_resize_classes = [2, 4],
        agnostic_resize_classes2 = [7, 8],
...
# dataset_type = 'DOTA20Dataset' # for test
angle_version = 'le90'
...
data_root = '/datasets/mmrotate_data/split_ss_dota1_5/' 
