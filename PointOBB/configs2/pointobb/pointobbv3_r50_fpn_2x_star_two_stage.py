...
model = dict(
    ...
    roi_head=dict(
        ...
        angle_coder=dict(
                    ...
                    thr_mod=0),
        angle_version = 'le90',
        rotation_agnostic_classes=[4, 21, 38, 44, 45, 47],
        agnostic_resize_classes = [16, 36],
    ...
    train_cfg=dict(
        ...
        rcnn=None,
        iter_count = 0,
        burn_in_steps1 = 27000, 
        burn_in_steps2 = 36000
    ),
    test_cfg=dict(
        rpn=None,
        rcnn=None,
...
data_root_trainval = '/mnt/petrelfs/liqingyun/yx/STAR/STAR/train/'
data_root_test = '/mnt/petrelfs/liqingyun/yx/STAR/STAR/STAR/train/'
...
# Inference
load_from = './work_dir/pointobb++/star/epoch_24.pth'

evaluation = dict(
    save_result_file='./work_dir/test/test_debug_result.json',
    do_first_eval=True
)
