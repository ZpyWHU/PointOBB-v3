...
model = dict(
    ...
    roi_head=dict(
        ...
        agnostic_resize_classes = [2, 4, 5, 6, 9, 11, 12, 13],
...
data_root_trainval = 'datasets/split_ss_dota1_5/trainval/'
data_root_test = '/datasets/split_ss_dota1_5/trainval/'
...
work_dir = './work_dir/pointobb++/dota15/'
...
# Inference
# load_from = './work_dir/dota15/epoch_24.pth'
# evaluation = dict(
