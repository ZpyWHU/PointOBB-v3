...
# dataset_type = 'STARDataset' # for test
angle_version = 'le90'
...
data_root_trainval = '/mnt//STAR/STAR/'
data_root_test = '/mnt/STAR/STAR/'
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        version=angle_version,
        ann_file = data_root_trainval + "train/trainval_1024_P2Bfmt_dota_rbox.json",
    ...
    test=dict(
        type=dataset_type,
        ann_file=data_root_test + "test/split_ss/images/",
        img_prefix=data_root_test + 'test/split_ss/images/',
        pipeline=test_pipeline))
