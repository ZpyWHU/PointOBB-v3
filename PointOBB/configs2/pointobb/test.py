...
model = dict(
    ...
    roi_head=dict(
        ...
        stacked_convs = 2,
        use_single_layer_feature = False,
...
data_root_trainval = '/mnt/petrelfs/liqingyun/zpy/data/dior/DIOR/'
data_root_test = '/mnt/petrelfs/liqingyun/zpy/data/dior/DIOR/'
