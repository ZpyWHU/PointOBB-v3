...
model = dict(
    ...
    roi_head=dict(
        ...
        agnostic_resize_classes = [0, 2, 3, 4],
    ...
    train_cfg=dict(
        ...
        rcnn=None,
        iter_count = 0,
        burn_in_steps1 = 110000, 
        burn_in_steps2 = 150000
    ),
    test_cfg=dict(
        rpn=None,
        rcnn=None,
...
data_root_trainval = '/mnt/petrelfs/share_data/liqingyun/datasets/mmrotate_data/RSAR/'
data_root_test = '/mnt/petrelfs/share_data/liqingyun/datasets/mmrotate_data/RSAR/'
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        version=angle_version,
        ann_file = data_root_trainval + "train/train_rbox_pt_P2Bfmt.json",
        img_prefix = data_root_trainval + 'train/images/',
...
work_dir = './work_dir/pointobb++/rsar/'
...
# Inference
load_from = './work_dir/pointobb++/rsar/pointobbv3/epoch_24.pth'
evaluation = dict(
