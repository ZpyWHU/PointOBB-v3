...
model = dict(
    ...
    roi_head=dict(
        ...
        agnostic_resize_classes = [2, 4, 5, 6, 9, 11, 12, 13, 17],
    ...
    train_cfg=dict(
        ...
        rcnn=None,
        iter_count = 0,
        burn_in_steps1 = 20000, 
        burn_in_steps2 = 27000
    ),
    test_cfg=dict(
        rpn=None,
        rcnn=None,
...
data_root_trainval = '/datasets/DOTA2.0/split_ss_dota/trainval/'
data_root_test = '/datasets/DOTA2.0/split_ss_dota/trainval/'
...
work_dir = './work_dir/pointobb++/dota20/'
...
# # Inference
# load_from = './work_dir/dota20/epoch_24.pth'
# evaluation = dict(
