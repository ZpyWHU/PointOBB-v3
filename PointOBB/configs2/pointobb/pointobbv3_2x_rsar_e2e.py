...
data_root_trainval = '/datasets/mmrotate_data/RSAR/'
data_root_test = '/datasets/mmrotate_data/RSAR/'
...
data = dict(
    ...
    val=dict(
        samples_per_gpu=8,
        type=dataset_type,
        ann_file = data_root_test + "test/test_rbox_pt_P2Bfmt.json",
