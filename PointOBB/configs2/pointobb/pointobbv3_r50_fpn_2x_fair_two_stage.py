...
model = dict(
    ...
    crop_size = (1024, 1024),
    construct_view = True,   # rot/flp view    #####Train should set True#####
    ...
    roi_head=dict(
        ...
        angle_coder=dict(
                    ...
                    thr_mod=0),
        angle_version = 'le90',
        rotation_agnostic_classes=[30, 31, 32],
        agnostic_resize_classes = [5, 11, 20, 21, 24, 25, 33],
        use_angle_loss = False,         #####Train should set False#####
        add_angle_pred_begin = False,   #####Train should set False#####
    ...
    train_cfg=dict(
        ...
        rcnn=None,
        iter_count = 0,
        burn_in_steps1 = 60000, 
        burn_in_steps2 = 80000
    ),
    test_cfg=dict(
        rpn=None,
        rcnn=None,
...
data_root_trainval = '/mnt/petrelfs/share_data/liqingyun/datasets/mmrotate_data/split_ss_fair1m_1_0/train/'
data_root_test = '/mnt/petrelfs/share_data/liqingyun/datasets/mmrotate_data/split_ss_fair1m_1_0/train/'
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        version=angle_version,
        ann_file = data_root_trainval + "trainval_1024_P2Bfmt_dota_rbox.json",
    ...
    test=dict(
        type=dataset_type,
        ann_file=data_root_test + "trainval_1024_P2Bfmt_dota_rbox.json",
...
work_dir = './work_dir/pointobb++/dota/'
...
# Inference
# load_from = './work_dir/pointobb++/fair/epoch_24.pth'
# evaluation = dict(
#     save_result_file='./work_dir/pointobb++/fair/result1.json',
#     do_first_eval=True
# )
