...
data_root_trainval = '/datasets/split_ss_dota/trainval/'
data_root_test = '/datasets/split_ss_dota/trainval/'
...
# Inference
# load_from = './work_dir/dota10/epoch_24.pth'
# evaluation = dict(
