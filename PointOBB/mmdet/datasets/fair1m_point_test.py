...
from .utils import eval_rbbox_map, poly2obb_np, obb2poly_np
...
class FAIR1MDataset(CustomDataset):
    ...
    def _results2submission(self, id_list, dets_list, out_folder=None):
        ...
        files = []
        self.predict_box_type = 'rbox'
        for img_id, dets_per_cls in zip(id_list, dets_list):
            outdir = osp.join(out_folder, img_id + '.xml')
        ...
        zip_path = osp.join(out_folder, target_name + '.zip')
