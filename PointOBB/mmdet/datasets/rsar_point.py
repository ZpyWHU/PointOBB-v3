...
class RSARPointDataset(CocoDataset):
    CLASSES = None
    ...
    def __init__(self,
        ...
        super(RSARPointDataset, self).__init__(
            ann_file,
            data_root=data_root,
            **kwargs
        )
    ...
    def _filter_imgs(self, min_size=32):
        valid_inds = super(RSARPointDataset, self)._filter_imgs(min_size)
    ...
    def __getitem__(self, idx):
        ...
        """
        data = super(RSARPointDataset, self).__getitem__(idx)
